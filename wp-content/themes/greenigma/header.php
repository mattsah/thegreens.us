			...
			<div class="row ">
				...
				<div class="col-md-6 col-sm-12">
					...
					<?php if($wl_theme_options['email_id']!='') { ?>
						<li class="email" data-toggle="tooltip" data-placement="bottom" title="Email"><a  href="mailto:<?php echo esc_attr($wl_theme_options['email_id']); ?>" target="_blank"><i class="fa fa-envelope"></i></a></li>
					<?php } if($wl_theme_options['phone_no']!='') { ?>
						<li class="phone" data-toggle="tooltip" data-placement="bottom" title="Telephone"><a  href="tel:<?php echo esc_attr($wl_theme_options['phone_no']); ?>" target="_blank"><i class="fa fa-phone"></i></a></li>
